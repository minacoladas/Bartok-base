...
public class BartokLayout : MonoBehaviour {
	...
	// SlotDef references
	public List<SlotDef> slotDefs; // The SlotDefs hand
	public SlotDef drawPile;
	public SlotDef discardPile;
	public SlotDef target;

	// This function si called to read ni the LayoutXML.xml file
	public void ReadLayout(string xmlText){
		...
		for (int i=0; i<slotsX.Count;i++){
			tSD = new SlotDef(); // Create a SlotDef instance
			...
			// In this game, theSorting Layers are named 1, 2, 3, ...through 10
